...
class CmdVelToArduino:
    ...
    def cmd_vel_callback(self, msg):
        ...
        rospy.loginfo(f"Received velocities: {linear_x}, {linear_y}, {angular_z}")

        # Kiểm tra nếu tất cả vận tốc đều bằng 0
        if linear_x == 0.00 and linear_y == 0.00 and angular_z == 1.00 or linear_x == 0.00 and linear_y == 0.00 and angular_z == 0.00 :
            data_to_send = "STOP\n"  # Lệnh dừng
        else:
